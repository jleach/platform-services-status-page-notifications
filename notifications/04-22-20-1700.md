...
If you application is sensitive to pod restarts you should proactivly move them between Monday morning when the nodes are unscheduled and Wednesday evening when they will be drained.
